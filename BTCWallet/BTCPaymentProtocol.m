...
@interface BTCPaymentProtocolDetails ()
...
@implementation BTCPaymentProtocolDetails
...
@interface BTCPaymentProtocolRequest ()
...
@implementation BTCPaymentProtocolRequest
...
- (instancetype)initWithData:(NSData *)data
{
    ...
    while (off < data.length) {
        ...
        switch ([data protoBufFieldAtOffset:&off int:&i data:&d]) {
            ...
            case request_details: if (d) _details = [BTCPaymentProtocolDetails detailsWithData:d]; break;
...
@interface BTCPaymentProtocolPayment ()

@property (nonatomic, strong) NSArray *refundToAmounts;

@end

@implementation BTCPaymentProtocolPayment
...
- (instancetype)initWithData:(NSData *)data
{
    ...
    while (off < data.length) {
        ...
        switch ([data protoBufFieldAtOffset:&off int:&i data:&d]) {
            ...
            case payment_transactions: if (d) tx = [BTCTransaction transactionWithMessage:d]; break;
...
@implementation BTCPaymentProtocolACK
...
- (instancetype)initWithData:(NSData *)data
{
    ...
    while (off < data.length) {
        ...
        switch ([data protoBufFieldAtOffset:&off int:&i data:&d]) {
            case ack_payment: if (d) _payment = [BTCPaymentProtocolPayment paymentWithData:d]; break;
