...
int BTCSecp256k1ModAdd(UInt256 *a, const UInt256 *b)
{
...
// returns true on success
int BTCSecp256k1ModMul(UInt256 *a, const UInt256 *b)
{
    dispatch_once(&_ctx_once, ^{ _ctx = secp256k1_context_create(SECP256K1_CONTEXT_SIGN | SECP256K1_CONTEXT_VERIFY); });
...
// returns true on success
int BTCSecp256k1PointGen(BTCECPoint *p, const UInt256 *i)
{
...
// returns true on success
int BTCSecp256k1PointAdd(BTCECPoint *p, const UInt256 *i)
{
    secp256k1_pubkey pubkey;
    size_t pLen = sizeof(*p);
...
// returns true on success
int BTCSecp256k1PointMul(BTCECPoint *p, const UInt256 *i)
{
    secp256k1_pubkey pubkey;
    size_t pLen = sizeof(*p);
